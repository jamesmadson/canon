...
sourceUrl: 'https://github.com/jamesmadson/canon/tree/main/plugin/graft/skills/graft'
...
fileTree:
  - path: SKILL.md
    type: file
    url: >-
      https://github.com/jamesmadson/canon/blob/main/plugin/graft/skills/graft/SKILL.md
contentOutline:
  - title: Hard rules
    subsections: []
  - title: Procedure
